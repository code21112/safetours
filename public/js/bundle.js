...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  "../../node_modules/core-js/modules/_global.js": [function (require, module, exports) {
    ...
    var displayMap = function displayMap(locations) {
      ...
      locations.forEach(function (location) {
        ...
        var popup = new mapboxgl.Popup({
          ...
          .setText("Day ".concat(location.day, ": ").concat(location.description)); // .setHTML(`<p>Day ${location.day}: ${location.description}</p>`)
        // .addTo(map);
        // Creating a marker

        var element = document.createElement('div');
        element.className = 'marker'; // Adding the marker

        new mapboxgl.Marker({
          element: element,
          anchor: 'bottom'
        }).setLngLat(location.coordinates).setPopup(popup).addTo(map); // Extending map bounds => including locations
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                // console.log('IN CATCH BLOCK'); // alert(err.response.data.message)
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                res = _context2.sent;
                if (res.data.status === 'success') window.location.reload(true); // if (res.data.success === 'success') Location.reload(forcedReload: true)
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                if (res.data.status === 'success') {
                  (0, _alerts.showAlert)('success', "Welcome ".concat(name, "! Your account has been created successfully!"));
                  window.setTimeout(function () {
                    location.assign('/');
                  }, 1500); // alert('Signed up successfully!')
                  // window.setTimeout(() => {
                  //     location.assign('/')
                  // }, 1500)
                }
    ...
    var stripe = Stripe('pk_test_Bika5pWBGJfW2m86KOhdlB3H00E5ymyeKH');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                console.log('SESSION', session); // 2) Creating the checkout form and Charging the credit card
